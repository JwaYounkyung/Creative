...
print("Preprocessing...")
# load data
tr_sents, tr_labels = utils.load_data(filepath='Outcome1/data/sent_class.train.csv')
ts_sents, ts_labels = utils.load_data(filepath='Outcome1/data/sent_class.test.csv')
